...
results.push(getTestMetric('Simple_GET_Respose.json', 'simple_GET_request'));
results.push(getTestMetric('PUT_Respose_test.json', 'put_responce'));
results.push(getTestMetric('POST_Respose_test.json', 'post_responce'));
results.push(getTestMetric('GET_serach_params.json', 'get_search_param'));
