...
/***************************************************************
 ...
 Command : 
 powershell windows: $env:K6_WEB_DASHBOARD="true"; k6 run -e env=perf -e TEST_TYPE=vu1d5m .\Test_Scripts\End_to_End_All_Methods.js
linux: K6_WEB_DASHBOARD=true K6_WEB_DASHBOARD_HOST=localhost K6_WEB_DASHBOARD_PORT=4032 K6_WEB_DASHBOARD_PERIOD=1s K6_WEB_DASHBOARD_EXPORT=./Simple_GET_Respose.html k6 run -e env=perf -e TEST_TYPE=vu1d5m .\Test_Scripts\End_to_End_All_Methods.js
